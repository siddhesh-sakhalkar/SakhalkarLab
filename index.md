...
Welcome to the M<sup>3</sup> Lab at the Indian Institute of Technology, Madras (IIT Madras)! We work at the intersection of mechanics, mathematics and artificial intelligence to design, simulate and optimize next-generation systems and devices. In particular, our lab's research focuses on developing theoretical frameworks, numerical models and machine learning methodologies to advance the mechanical design of engineering systems across multiple length scales — from macro to micro and nano. 
...
As a new lab, we are actively looking for interested undergraduate, graduate (Masters/PhD) and post-doctoral candidates to join our team!
